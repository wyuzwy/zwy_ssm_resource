    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <ul class="clearfix">
                ...
                <li style="display:block">
                    <a class="list-group-item active" title="我的收藏">我的收藏</a>
                </li>
            </ul>
        </div>
            ...
            <div class="panel panel-default ">
                <div class="container-fluid">
                    <div style="margin: 20px">
                                ...
                                <div hidden="" class="alert alert-dismissable alert-success" id="tipes12">
...
<script type="text/javascript">
    ...
    function show_resource(result) {
        ...
        $.each(res,function (index,item) {
            ...
            var center4_2=$("<button></button>").addClass("btn btn-danger btn-sm delete_btn").append("取消收藏");
            center4_2.attr("del-id",item.resourceId);
            center4_1.append(center4_2);
            center2.append(center4_1);
